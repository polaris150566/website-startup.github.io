...
### npm commands
```shell-script
yarn run build # build output pages to public/
yarn run start # when there is public/, serve web page from it
yarn run lint  # format your code
yarn run clean # remove public/
yarn run dev   # view the page without building public/
```
...
#### Install
```bash
git clone https://gitlab.igem.org/2024/ustc.git
cd ustc
python3 -m venv venv
